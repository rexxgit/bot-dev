// ============================================================
// GROK PROMPTS ENGINE - Conscientiousness Edition v2.1
// ============================================================
...
[Source 2] - Confidence: X/10`,
  ...
  // ============================================================
  // NEW: CONTEXTUAL ANALYSIS INTENT
  // ============================================================
  contextual: {
...
• Use bold for section headers`,
  ...
  // ============================================================
  // NEW: CHAIN-OF-THOUGHT WITH CONTEXTUAL ANALYSIS
  // ============================================================
  cotContextual: {
...
• Use bold for step headers`,
  ...
  // ============================================================
  // NEW: SYNTHESIS WITH PROPER FORMATTING
  // ============================================================
  synthesis: {
 ...
 */
export function getContextualPrompt(useCoT = false) {
...
export function buildContextualRequest(query, context, options = {}) {
  ...
  const prompt = getContextualPrompt(useCoT);
  const personality = options.personality || 'conscientiousness';
 ...
 * @returns {object} Complete Grok API request object
 */
export function buildGrokRequest(query, context, intent = 'informational', personality = 'balanced', options = {}) {
...
export function validateGrokRequest(request) {
  ...
  const hasAllFields = requiredFields.every(function(field) {
